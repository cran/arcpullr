...
<summary
  style="
    ...
    font-weight: bold;
    list-style: none;">
<strong>Example Source Data</strong></summary>
```{r}
...
[Wisconsin Dep't. of Natural Resources 24K Hydrography
layer](https://dnrmaps.wi.gov/arcgis/rest/services/WT_SWDV/WY_INLAND_WATER_RESOURCES/MapServer/2),
for example.
